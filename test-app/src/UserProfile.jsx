...
function UserProfile() {
  ...
  return (
    <div className="user-profile">
      <h2 className='profile-user'>Профиль пользователя</h2>
      <div className="user-info">
        <p className='name'><strong>Имя:</strong> {user.name}</p>
        <p className='email'><strong>Email:</strong> {user.email}</p>
        <p className='tel'><strong>Телефон:</strong> {user.phone}</p>
        <p className='web'><strong>Website:</strong> {user.website}</p>
      </div>
    </div>
  );
}
