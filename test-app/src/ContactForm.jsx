...
function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="contact-form">
      <h2 className='feedback-form'>Форма обратной связи</h2>
      
      {/* Поле имени */}
      <div className="form-group">
        <label htmlFor="name" className='name-form'>Имя </label>
        <input
          id="name"
          type="text"
          name="name"
      ...
      <div className="form-group">
        <label htmlFor="phone" className='tel-form'>Телефон </label>
        <input
          id="phone"
          type="tel"
          name="phone"
      ...
      {/* Поле сообщения */}
      <div className="form-group">
        <label htmlFor="message" className='message-form'>Сообщение </label>
        <textarea
          id="message"
          name="message"
